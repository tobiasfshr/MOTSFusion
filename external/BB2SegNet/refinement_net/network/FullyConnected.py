...
from external.BB2SegNet.refinement_net.network.Util import get_activation, prepare_input, apply_dropout


# See also savitar1
class FullyConnected(Layer):
  def __init__(self, name, inputs, n_features, tower_setup, activation="relu", dropout=0.0, batch_norm=False,
               batch_norm_decay=Layer.BATCH_NORM_DECAY_DEFAULT, l2=Layer.L2_DEFAULT):
