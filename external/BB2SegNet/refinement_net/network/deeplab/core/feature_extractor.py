...
# A map from refinement_net.network name to network function.
networks_map = {
    'mobilenet_v2': _mobilenet_v2,
    'xception_65': xception.xception_65,
}

# A map from refinement_net.network name to network arg scope.
arg_scopes_map = {
...
# A dictionary from refinement_net.network name to a map of end point features.
