...
def load_gt_sequences(gt_dir, seqs):
  objects_per_frame_per_sequence = {}
  for seq in seqs:
    print("Loading sequence", seq)
    seq_path_txt = os.path.join(gt_dir, seq + '.txt')
...
def load_sequences(result_dir, seqs):
  objects_per_frame_per_sequence = {}
  for seq in seqs:
    print("Loading sequence", seq)
    seq_path_txt = os.path.join(result_dir, seq + '/mots_result')
    if os.path.exists(seq_path_txt):
        objects_per_frame_per_sequence[seq] = load_txt(seq_path_txt)
